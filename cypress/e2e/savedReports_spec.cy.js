describe('Saved Reports', () => {
  ...
  it('Should view saved reports allowing a user to delete one and navigate back to /match', () => {
    ...
    .get('.saved-report').first().find('p').first().should('have.text', 'Lady Young & Levi Ackerman')
    ...
    .get('.saved-report').first().find('p').first().should('have.text', 'Lady Young & Leorio Paradinight')
